...
-- targetText   : what the server prints when the emote has a target. An empty
--                string means the emote has no targeted form, so the menu
--                forces DoEmote(emote, "none").
-- animated     : the emote plays a character animation.
-- voiced       : the emote plays a voice line.
--
-- Kept alphabetical by emote. The result text is server-generated and is not
-- available from the client, so it has to live here; it stays English on
-- non-enUS clients.
